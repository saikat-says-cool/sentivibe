  ...
  return (
    <div className="container mx-auto p-4 max-w-3xl">
      ...
      <Card className="mb-6">
        ...
        {blogPost.ai_analysis_json?.emotional_tones && blogPost.ai_analysis_json.emotional_tones.length > 0 && (
          <CardContent className="border-t pt-4 mt-4">
        ...
        {blogPost.ai_analysis_json?.key_themes && blogPost.ai_analysis_json.key_themes.length > 0 && (
          <CardContent className="border-t pt-4 mt-4">
