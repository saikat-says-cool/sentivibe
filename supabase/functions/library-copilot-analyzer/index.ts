...
serve(async (req: Request) => {
  ...
  try {
    ...
    const { userQuery, blogPostsData, deepThinkMode, deepSearchMode } = await req.json(); // Removed desiredWordCount
    ...
    **Conversation Guidelines:**
    ...
    9.  **Integrity:** Do not invent blog posts or provide links to non-existent slugs. Only use the provided \`blogPostsData\` for existing recommendations.
    `;
