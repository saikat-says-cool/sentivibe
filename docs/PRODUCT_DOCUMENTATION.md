...
3.  **Create a Multi-Video Comparison:**
    ...
    *   **Add Custom Comparative Questions (Unlimited):** Use the "Add Another Comparative Question" button to add questions specifically for comparative insights, with desired word count limits.
